...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4">
            <input type="text" name="user_name" id="" class="form-control m-auto w-50"
                value="<?php echo $user_session_name ?>">

        </div>

        <div class="form-outline mb-4">
            <input type="email" name="user_email" id="" class="form-control m-auto w-50"
        ...
        <div class="form-outline mb-4">
            <input type="text" name="user_address" id="" class="form-control m-auto w-50"
                value="<?php echo $user_address ?>">

        </div>

        <div class="form-outline mb-4">
            <input type="text" name="user_number" id="" class="form-control m-auto w-50"
                value="<?php echo $user_mobile ?>">

        </div>

        <input type="submit" value="Update" name="user_update" class="py-2 px-3 text-white border-0 m-auto  "
