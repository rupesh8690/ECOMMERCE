...
<div class="row">
    ...
    <!--side navbar-->
    <div class="col-md-2 second-nav-bg p-0 mb-2">
      <ul class="navbar-nav me-auto text-center">
        <li class="item  custom-color">
          <a href="#" class="nav-item text-light text-justify   text-decoration-none"> <h4 class="text-center">Delivary Brands</h4></a>
        ...
        <!--categories--->
          ...
          <ul class="navbar-nav me-auto text-center">
        <li class="item   custom-color">
          <a href="#" class="nav-item text-light text-justify text-decoration-none"> <h4 class="text-center">Categories</h4></a>
        </li>
