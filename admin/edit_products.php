  ...
  <div class="container">
    ...
    <form action="" method="post"  enctype="multipart/form-data">
        <div class="form-outline mb-4 ">
            ...
            <input type="text" name="product_title" id="product_title" class="form-control w-75 " value="<?php echo $product_title ?>" required="required">
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="product_keyword"  class="form-control w-75" value="<?php echo $product_keywords ?>" required="required">
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="product_price"  class="form-control w-75" value="<?php echo $product_price ?>" required="required">
        </div>
