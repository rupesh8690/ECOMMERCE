...
<body class="">
    <div class="container cont-bg ">
        ...
        <div class="form-group  w-50 m-auto ">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" name="product_title" placeholder="Enter product title" autocomplete="off" required="required">
        </div>
        ...
        <div class="form-group  w-50 m-auto">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" name="product_description" placeholder="Enter product description" autocomplete="off" required="required">
        </div>
            
        <!--keywords--->
        <div class="form-group  w-50 m-auto">
            <label for="product_keywords" class="mt-3">Product keywords</label>
            <input type="text" class="form-control" id="formGroupExampleInput" name="product_keyword" placeholder="Enter product keywords" autocomplete="off" required="required">
        </div>
        ...
        <input type="number" class="form-control" id="product_price" name="product_price" placeholder="Enter product price" autocomplete="off" required="required">
        </div>
